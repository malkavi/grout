...
| Commodore C64/128/MAX         | c64                        | *(none)*            |
...
| Family Computer Disk System   | fds                        | *(none)*            |
...
| Neo Geo Pocket Color          | neo-geo-pocket-color       | *(none)*            |
...
| Virtual Boy                   | virtualboy                 | *(none)*            |
| WonderSwan                    | wonderswan                 | WS                  |
| WonderSwan Color              | wonderswan-color           | *(none)*            |
